...
class PublicIngredientsApiTests(TestCase):
    """Testea la api de ingredientes PUBLICA"""

    def setUp(self):
        self.client = APIClient()
    
    def test_login_required(self):
        """Testea que sea necesario estar logeado para acceder."""
...
class PrivateIngredientsApiTests(TestCase):
    """Testea la api de ingredientes, a travez de un usuario logeado."""
    ...
    def test_ingredients_limited_to_user(self):
        ...
        Ingredient.objects.create(user=usuario2,name='Jamon')
        ingrediente = Ingredient.objects.create(user=self.user,name='Queso')
        res = self.client.get(INGREDIENTS_URL)
